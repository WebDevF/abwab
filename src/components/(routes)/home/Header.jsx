...
export default function Header() {
  ...
  return (
    <div className="flex flex-col items-center justify-center px-4 sm:px-6 md:px-2 py-5 relative">
      <div
        className="grid w-[350px] h-[400px] sm:h-[600px] md:h-[835px] md:w-[1300px] rounded-[2.5rem] md:rounded-[4.5rem] py-4 md:p-8 bg-cover bg-center overflow-hidden"
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center text-center text-white p-5 sm:p-6 md:p-10 z-10 -translate-y-10 md:-translate-y-20">
          ...
          <button className="text-white text-[9px] sm:text-[18px] md:text-[26px] border-1 border-white mt-2 px-4 sm:px-10 py-1 sm:py-4 rounded-full font-[400] cursor-pointer hover:bg-[#FFFFFF3A] hover:text-white">
            {t("header.header_btn")}
          </button>
        </div>
      </div>
