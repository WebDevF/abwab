...
export default function Tools() {
  ...
  const tools = [
    ...
    { src: "/public/assets/img/tools/devicon_vuejs.svg", bgColor: "#FFFFFF" },
    { src: "/public/assets/img/tools/logos_javascript.svg", bgColor: "#F7DF1E" },
    { src: "/public/assets/img/tools/skill-icons_angular-light.svg", bgColor: "#F4F2ED" },
    { src: "/public/assets/img/tools/logos_nodejs.svg", bgColor: "#FFFFFF" },
    { src: "/public/assets/img/tools/Vector (17).svg", bgColor: "#E14E1D" },
    { src: "/public/assets/img/tools/vscode-icons_file-type-reactjs.svg", bgColor: "#FFFFFF" },
    { src: "/assets/img/tools/devicon_php.svg", bgColor: "#777BB3" },
    { src: "/public/assets/img/tools/devicon_vuejs.svg", bgColor: "#FFFFFF" },
    { src: "/public/assets/img/tools/logos_javascript.svg", bgColor: "#F7DF1E" },
    { src: "/public/assets/img/tools/skill-icons_angular-light.svg", bgColor: "#F4F2ED" },
